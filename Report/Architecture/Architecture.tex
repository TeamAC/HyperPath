...
clients.\todo[inline,size=\footnotesize]{Add the security strategy or the
...
\ldots\todo[inline,size=\footnotesize]{may be this figure need rework, adding
extra mobile device, emphsis the mobility nature of android client and soap communication protocole used in the
communication???}
\ldots\todo[inline,size=\footnotesize]{Where is the BIRT and datawarehousing
part ???}
