...
public class MapWidget extends Canvas {
    ...
    protected void paintControl(PaintEvent e) {
        ...
        PointD marker_pt = new PointD(36.80843, 10.16901);
        System.out.println("X = " + (marker_pt.x - mapPosition.x) + " Y = "+ (marker_pt.y - mapPosition.y));
    ...
    private void paintMarkers(GC gc, int x, int y) {
        Image marker = Activator.getImageDescriptor("icons/marker-red.png").createImage();
