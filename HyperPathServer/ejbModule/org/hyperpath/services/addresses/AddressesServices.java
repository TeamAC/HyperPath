...
public class AddressesServices {
    ...
    public List<Address> listAllAddress() throws 
            Exception,
    ...
    public void addAddress(@WebParam(name = "address")
            ...
            PreexistingEntityException 
    {
        ...
        try{
            if(controller.findAddress(address) == null){
                ...
                throw  new PreexistingEntityException("Address already present in the database");
            }
        }catch(Exception e){
            throw e;
        }
    ...
    public void updateAddress(@WebParam(name = "address")
    Address address) throws 
            Exception,
            RollbackFailureException,
            PreexistingEntityException
    ...
    public void deleteAddress(@WebParam(name = "address")
    Address address) throws 
            Exception,
            RollbackFailureException,
            NonexistentEntityException {
        ...
        try{
            ...
            if((id = address.getId()) != null || controller.findAddress(address) != null){
                ...
                throw new Exception("To delete address the id field must be specified or the address must match one in the database");
            }
        }catch(Exception e){
            throw e;
        }
    ...
    public Address findAddress(@WebParam(name = "category") Categories category,
    @WebParam(name = "address") String address) throws 
            Exception,
            NonexistentEntityException 
    {
    ...
    public Address findAddressByLocation(@WebParam(name = "category")
    Categories category, @WebParam(name = "location")
    String location, @WebParam(name = "range")
    int range) throws NonexistentEntityException {
    ...
    public List<org.hyperpath.persistence.entities.Services> findServiceByAddress(@WebParam(name = "address")
    Address address) throws 
            Exception,
            NonexistentEntityException {
        try{
         ...
         if(rs.isEmpty())
             throw new NonexistentEntityException("There is no service in this address");
         return rs;
       }catch(Exception e){
           throw e;
       }
    ...
    public List<org.hyperpath.persistence.entities.Advertisers> findAdvertizerByAddress(@WebParam(name = "address")
    Address address) throws 
       Exception ,
       NonexistentEntityException {
       ...
       try{
         ...
         if(rs.isEmpty())
             throw new NonexistentEntityException("There is no advertizers in this address");
         return rs;
       }catch(Exception e){
           throw e;
       }
