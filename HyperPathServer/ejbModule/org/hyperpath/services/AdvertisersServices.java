...
public class AdvertisersServices {
  ...
  public List<Advertisers> findAdvertisersByAddress(@WebParam(name = "address") Address address)
    throws
    Exception,
  ...
  public List<Advertisers> findAdvertiserByPhone(@WebParam(name = "phone") String phone)
    throws
    Exception,
    NonexistentEntityException,
    RollbackFailureException
  ...
  public List<Advertisers> findAdvertisersByFax(@WebParam(name = "fax") String fax)
    throws
    Exception,
    NonexistentEntityException,
    RollbackFailureException
  ...
  public List<Advertisers> findAdvertisersByMail(@WebParam(name = "mail") String mail)
    throws
    Exception,
    NonexistentEntityException,
    RollbackFailureException
