...
public PhonesJpaController(EntityManager mockedEM) {
  ...
  public void create(Phones phones) throws RollbackFailureException,
    ...
    try {
      ...
      for (Entities entitiesListEntitiesToAttach : phones
          .getEntitiesList()) {
  ...
  public void edit(Phones phones) throws NonexistentEntityException,
    ...
    try {
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findPhones(id) == null) {
          throw new NonexistentEntityException("The phones with id "
              + id + " no longer exists.");
        }
      }
      throw ex;
  ...
  public void destroy(Integer id) throws NonexistentEntityException,
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException("The phones with id " + id
