...
public class Clients implements Serializable {
    ...
    @JoinTable(name = "clients_reviews", 
        joinColumns        = { @JoinColumn(name = "clients_id",  referencedColumnName = "id", nullable = false)},
        inverseJoinColumns = { @JoinColumn(name = "reviews_id",  referencedColumnName = "id", nullable = false)})
    @ManyToMany
    private List<Reviews> reviewsList;
    @JoinTable(name = "clients_bookmarked_services", 
        joinColumns        = {@JoinColumn(name = "clients_id" , referencedColumnName = "id", nullable = false)}, 
